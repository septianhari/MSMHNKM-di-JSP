...
<center><img src="pc.png" width="150" height="150"> 
<img src="aku1.png" align="right"  width="150" height="150"></center>
    <a href="shsOneView.html">Back</a>
  <hr class="new1">
<style>
table{
  width:100%;
...
body{
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>institution Name: Iam-Tech</th>
...
<body>
  <table>
    ...
    <tbody>
      <tr>
        <td>M101</td>
        <td colspan="2">Citizenship education</td>
        <td>Theory</td>
        <td>100</td>
        <td> 30 </td>
      ...
      <tr>
        <td>M103</td>
        <td colspan="2">Introduction to information technology</td>
        <td>Theory</td>
        <td>100</td>
        <td> 30 </td>
      ...
      <tr>
        <td>MK101</td>
        <td colspan="2">Basic social knowledge</td>
        <td>Theory</td>
        <td>100</td>
        <td> 30 </td>
      ...
      <tr>
        <td>MKD101</td>
        <td colspan="2">Programming algorithms & data structures</td>
        <td>Theory</td>
        <td>100</td>
        <td> 30 </td>
      ...
      <tr>
        <td>M152</td>
        <td colspan="2">Programming algorithm & data structure lab</td>
        <td>Practical</td>
        <td>30</td>
        <td>15</td>
...
Designed & Developed by ESHAES</h6></center>
  <hr class="new1">
<center><h6>ESHAES :2022</h6></center> 
  <hr class="new1">
</body>
...
{
	response.sendRedirect("errorShsOneView.html");
	}
}
catch(Exception e)	
{}%>