...
<!DOCTYPE html>
<html>
<title>Iam-Tech</title>
<body>
<img src="logo.png"  align="left"width="100" height="100">

<img src="aku1.png" align="right"  width="100" height="100"></center>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Citizenship education</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">English 1</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Introduction to information technology</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Basic social knowledge</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Programming algorithms & data structures</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Programming algorithm & data structure lab</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Object oriented programming</label>
                                    <div class="col-md-6">
...
<section>
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>Roll Number</th>
          <th>Citizenship education</th>
          <th>English 1</th>
          <th>Introduction to information technology</th>
          <th>Basic social knowledge</th>
          <th>Programming algorithms & data structures</th>
          <th>Programming algorithm & data structure lab</th>
  ...
  <center><h5></h5></center>
  <hr class="new1">
<center><h5>ESHAES : 2022</h5></center> 
  <hr class="new1">
<br>
</body>
</html>